...
export const QUOTES = [
  ...
  },
  {
    ...
    handle: "@GergelyOrosz",
    date: "2026-08-20",
    avatar: "/avatars/gergelyorosz.jpg",
    quote:
...
] as const satisfies readonly ProductQuote[];
